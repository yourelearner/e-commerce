...
<head>
   ...
   <title>Home | Bound and Noble</title>
...
<section class="home">
   <div class="content">
      ...
      <p>Pick a book and receive it at your doorstep.</p>
...
if ($total_pages > 1) {
    ...
    if($page > 1){
        echo '<a href="index.php?page='.($page-1).'" class="btn">Prev</a>';
    }
...
<section class="home-contact">
   <div class="content">
      ...
      <p>If you have any further questions or concerns, click the contact button and message us. We will get back to you as soon as we can.</p>
